<template>
  <div>
    ...
    <el-table  style="width: 100%" border :data="list">
      <el-table-column type="index" prop="date" label="序号" width="80px" align='center'> </el-table-column>
...
export default {
  name: "tradeMark",
  data() {
    //自定义校验规则rule规则，valuey用户输入的文本值，callback放行函数
  ...
  methods:{
    ...
    deleteTradeMark(row){
      this.$confirm(`你确定删除${row.tmName}?, 是否继续?`, '提示', {
          ...
          //当前页面只有一条数据的时候，单击删除，list代表当前页有多少条数据，此时页面要往回走，所以要再次渲染页面
          //再次获取品牌列表数据
